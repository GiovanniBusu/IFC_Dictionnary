...
DATA.append(entry(
    ...
    [
        pt("FLEXIBLE", "4.3", "Pavement with a bituminous surfacing and a base layer with or without a hydrocarbon binder.",
           "Chaussée souple, à surface bitumineuse et couche de base avec ou sans liant hydrocarboné.",
           {"fr": ["chaussée souple"], "en": ["flexible pavement"], "it": ["pavimentazione flessibile"],
            "de": ["Flexibler Fahrbahnbelag"]}, new_in_43=True),
...
DATA.append(entry(
    ...
    [
        ...
        pt("PAVEMENT", "4.3", "A layer within a pavement structure that forms a paved area or road.",
           "Couche de chaussée formant une aire pavée ou une route.",
           {"fr": ["couche de chaussée"], "en": ["pavement course"], "it": ["strato di pavimentazione"],
            "de": ["Fahrbahnschicht"]}, new_in_43=True),
